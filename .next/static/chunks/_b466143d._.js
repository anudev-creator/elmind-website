...
"[project]/src/app/ResetPassword/page.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const useRouter = ()=>{
    return {
        push: (path)=>{
            console.log("[Router Push]: ".concat(path));
            if (path === '/login') alert("Success! Redirecting to Login Page...");
        },
        replace: (path)=>{
            console.log("[Router Replace]: ".concat(path));
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ResetPasswordSecure.useEffect": ()=>{
            ...
            if (sessionStorage.getItem('elmind_page_visited')) {
                ...
                }["ResetPasswordSecure.useEffect"], 100);
                setAuthorized(false);
                return;
            }
...
_s(ResetPasswordSecure, "TwVFfi0RgkuKh2hPjCM79U/oL8k=", false, function() {
    return [
        useRouter
    ];
});
_c2 = ResetPasswordSecure;
var _c, _c1, _c2;
__turbopack_context__.k.register(_c, "MenuBar");
__turbopack_context__.k.register(_c1, "Footer");
__turbopack_context__.k.register(_c2, "ResetPasswordSecure");
...
//# sourceMappingURL=_b466143d._.js.map